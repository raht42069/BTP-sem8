...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str, default="/content/drive/MyDrive/BTP-sem8/data")
    parser.add_argument('--data_name', type=str, default='rain100L', choices=['rain100L', 'rain100H'])
    parser.add_argument('--save_path', type=str, default='/content/drive/MyDrive/BTP-sem8/result')
